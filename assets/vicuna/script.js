...
modelFigureMapping = {
    ...
    "llama": "assets/vicuna/figures/llama.jpg",
}
...
function displayAnswers(index) {
    ...
    const colorRed ='#fcb'; // '#eb978d';
    // const colorGreen = '#c9f2c9';
    const colorBlue = '#cef'; // '#71dbf9';
    const colorYellow = '#fea'; // '#fada57';
