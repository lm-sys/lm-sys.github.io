...
This work is jointly completed by the **InfiXAI Team, Ant Group AQ Team, SGLang RL Team, and Miles Team**. Special thanks to **[Verda Cloud](https://verda.com/)** for compute sponsorship and to **NVIDIA** for technical support on Transformer Engine (TE).
