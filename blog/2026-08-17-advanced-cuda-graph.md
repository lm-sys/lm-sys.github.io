...
In SGLang, we refactored CUDA Graph support around a common runner/backend interface, making different capture strategies reusable across execution paths. **Breakable CUDA Graph (BCG) is an SGLang-originated serving technique: it was first proposed, named, implemented, and open-sourced in SGLang**, beginning with [[#19102](https://github.com/sgl-project/sglang/pull/19102)] and later extended to prefill in [[#22218](https://github.com/sgl-project/sglang/pull/22218)]. This lineage is also explicit in vLLM's later implementation, whose [source](https://github.com/vllm-project/vllm/blob/8a56da3845270837424ef4b7ee83ca97a7883025/vllm/compilation/breakable_cudagraph.py#L3-L13) identifies SGLang #19102 as its inspiration. SGLang also pioneered full CUDA Graph support for prefill with the FA4 and FlashInfer attention backends. We also dive deeper into CUDA Graph memory management, including memory reuse across shapes and graph segments, which is becoming an increasingly important part of SGLang’s overall memory management.
...
<ul style="line-height: 1.75;">
  ...
  <li style="padding-top: 0.55em;"><strong>May 2026: vLLM adopted the approach.</strong> vLLM <a href="https://github.com/vllm-project/vllm/pull/42304">#42304</a> was opened on May 11 and merged on May 16. Its implementation <a href="https://github.com/vllm-project/vllm/blob/8a56da3845270837424ef4b7ee83ca97a7883025/vllm/compilation/breakable_cudagraph.py#L3-L13">explicitly identifies</a> the idea as inspired by <code>sgl-project/sglang#19102</code>.</li>
</ul>
