---
title: "MiniMax-H3 on 8×H200: Up to 6.24× Faster Video Generation with SGLang Diffusion"
...
- **Stacking step reuse and sparse attention reaches up to 6.24×.** The fastest tested
  profile, SubBlock 0.80 + Cache-DiT stride, delivers **5.06×/5.72×** on 5 s/10 s T2VA
  and **5.86×/6.24×** on FL2VA.
