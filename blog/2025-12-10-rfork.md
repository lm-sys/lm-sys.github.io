...
The performance of data transfer using traditional method is low, because there is always bottleneck in the entire path, whose bandwidth is much smaller than inter-node device-to-device interconnect. 
