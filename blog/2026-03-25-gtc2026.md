...
author: "Lingyan Hao, The SGLang Adoption Team"
date: "March 25, 2026"
previewImg: /images/blog/gtc2026/happyhour-crowd.jpg
---

# SGLang at NVIDIA GTC 2026

**by: Lingyan Hao, The SGLang Adoption Team, March 25, 2026**

SGLang came to NVIDIA GTC 2026 with panels, a happy hour, a 200-person meetup, and a hands-on training lab. Three days, four events, one packed week at the center of the LLM ecosystem and left with a lot to share. If you missed it, here's the full recap.

<img src="/images/blog/gtc2026/hero-collage.jpg" style="display: block; margin: 20px auto 0; width: 100%; max-width: 100%; height: auto;" />
<p style="text-align: center; color: #666; font-style: italic;">SGLang at GTC 2026 — three events, three days.</p>


## Open-Source AI Panel at GTC

On Tuesday afternoon, **Ying Sheng** joined the GTC panel **"The State of Open-Source AI"** alongside Vartika Singh (Strategic AI Lead, NVIDIA), Jonathan Cohen (VP of Applied Research, NVIDIA), Ion Stoica (Professor, EECS, UC Berkeley), Jeff Boudier (VP of Product, Hugging Face), and Ranjay Krishna (Director of Multimodal and Embodied AI, Ai2).
...
- **Banghua Zhu (RadixArk)** introduced RadixArk and the **Miles** RL training framework, designed for large-scale MoE post-training workloads.

- **Jason Zhao (ScitiX)** presented **SiMM**, an open-source in-memory KV cache engine built for long-context serving.
...
**Banghua Zhu** joined Novita's GTC event with over 700 attendees. The discussion covered Jensen Huang's remarks on the inflection point between inference cost and demand, the key drivers behind the agentic AI movement, and what it takes for AI products to deliver real value.
...
- **Luke Simon and Xi Liu (Meta)** — Generative Reasoning Reranker [[paper]](https://lnkd.in/gGFwdkJw)
...
- Semantic ID vs. embedding retrieval — tradeoffs at scale
...
GTC 2026 made clear how much the production LLM ecosystem is converging around open-source infrastructure. From semantic search at LinkedIn scale to RL post-training for frontier MoE models, SGLang is increasingly the shared layer underneath.

We'll keep building in the open. Follow our [Luma calendar](https://luma.com/SGLang-meetups) for future meetups, office hours, and community events.


## Acknowledgment

We would like to thank everyone who has contributed to or support these event.
- The SGLang Core Team and Speakers: Ying Sheng, Banghua Zhu, Baizhou Zhang, Qiaolin Yu, Yueming Yuan, Mao Cheng, Liangsheng Yin and many others
- The SGLang Adoption Team: Mingyi Liu, Haoguang Cai, Harry He, Lingyan Hao, Richard Chen and many others