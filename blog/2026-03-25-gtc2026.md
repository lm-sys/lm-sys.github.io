...
📝 [X post](https://x.com/lmsysorg/status/2033675233765499277)
...
**Banghua Zhu** joined Novita's GTC event with over 700 attendees. The discussion covered Jensen Huang's remarks on the inflection point between inference cost and demand, the key drivers behind the agentic AI movement, and what it takes for AI products to deliver real value. Banghua shared his perspective on the future of inference infrastructure, from SGLang, OpenClaw to agentic inference, and talked about the evolution of open models and infrastructure.
