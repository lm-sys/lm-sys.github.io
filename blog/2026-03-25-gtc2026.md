...
**Banghua Zhu** joined Novita's GTC event with over 700 attendees. The discussion covered Jensen Huang's remarks on the inflection point between inference cost and demand, the key drivers behind the agentic AI movement, and what it takes for AI products to deliver real value. Banghua shared his perspective on the future of inference infrastructure, from SGLang and OpenClaw to agentic inference, and the evolution of open models and open infrastructure.
