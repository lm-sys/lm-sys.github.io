...
Here, we follow [Megatron-LM](arxiv.org/pdf/2104.04473.pdf) to estimate the forward cost of the LLM. In a transformer model's forward pass, the FLOPs will be 

$$ 96Bslh^2(1+\frac{s}{6h}+\frac{V}{16lh) $$
