...
The key to preserving decoding distribution while reducing the number of steps lies in consistently looking ahead and **predicting** a series of future tokens and simultaneously **verifying** these tokens during the decoding process, 
following the guess-and-verify paradigm. 
Different from previous methods, Lookahead decoding does not need a draft model and uses itself to generate guess candidates by a modified Jacobi decoding in a **prediction branch**. 
...
<img src="/images/blog/laattention/fold-perf.png" style="display:block; margin-top: auto; margin-left: auto; margin-right: auto; margin-bottom: auto; width: 200%; max-width: 100%"></img>
