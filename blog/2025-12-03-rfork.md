...
author: "Ant Group DeepXPU Team"
date: "December 3, 2025"
previewImg: /images/blog/rfork/preview.svg
---

## TL;DR
This blog presents **Tensor R-Fork** (stands for Tensor Remote Fork) , a novel weight loading methodology that leverages **efficient inter-node GPU-to-GPU data transfer path** to load tensors from a running SGLang instance to a new instance with **zero-copy**.
...
*Want to learn more about TransferEngine? You are more than welcome to check **TransferEngine 101** in Appendix session 🚀
...
We evaluated the performance of launching a new SGLang instance equipped with eight NVIDIA H20 GPUs, while loading Deepseek-R1 model from different sources.  
...
** Registering memory region can be overlapped with other initialization phases to further optimize total boot-up time.
