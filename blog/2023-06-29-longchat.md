...
In addition, LongChat can not only handle such a long context length but also precisely follow human instructions in dialogues and demonstrate strong performance in the human preference benchmark [MT-Bench](https://github.com/lm-sys/FastChat/tree/main/fastchat/llm_judge). 
...
## Disclaimer
The benchmark longeval introduced in this blogpost is not yet a rigorous academic benchmark. We are actively working on more systematic benchmarking.
