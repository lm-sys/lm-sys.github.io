...
To better enable agentic workflows, SGLang now offers OpenAI Reponse API support and native OpenAI compatible chat completion support. Here is an example of how to build a simple web search agent with SGLang.
...
Use Response API to Do a Web Search:
